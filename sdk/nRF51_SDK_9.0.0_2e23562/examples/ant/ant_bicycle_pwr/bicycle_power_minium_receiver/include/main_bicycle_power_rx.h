...
#ifndef MAIN_BICYCLE_POWER_RX_H__
#define MAIN_BICYCLE_POWER_RX_H__

/** @brief Function for running the bicycle power RX main processing loop. Does not return. 
 */
void bicycle_power_rx_main_loop_run(void); 

#endif // MAIN_BICYCLE_POWER_RX_H__
