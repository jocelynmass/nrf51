...
enum opt_code
{
  ...
  OPT_mapcs = 1152,                          /* -mapcs */
  OPT_mapcs_frame = 1153,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1154,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1155,              /* -mapcs-stack-check */
  OPT_march_ = 1156,                         /* -march= */
  OPT_marm = 1157,                           /* -marm */
  OPT_masm_syntax_unified = 1158,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1159,                    /* -mbig-endian */
  ...
  OPT_mcmse = 1162,                          /* -mcmse */
  OPT_mcpu_ = 1163,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1164,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1165,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1166,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1167,                  /* -mfp16-format= */
  OPT_mfpu_ = 1168,                          /* -mfpu= */
  /* OPT_mhard_float = 1169, */              /* -mhard-float */
  OPT_mlittle_endian = 1170,                 /* -mlittle-endian */
  OPT_mlong_calls = 1171,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1172,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1173,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1174,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1175,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1176,               /* -mprint-tune-info */
  OPT_mpure_code = 1177,                     /* -mpure-code */
  ...
  OPT_munaligned_access = 1191,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1192,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1193,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1194,              /* -mword-relocations */
  OPT_n = 1195,                              /* -n */
  OPT_no_canonical_prefixes = 1196,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1197,              /* -no-integrated-cpp */
  OPT_no_pie = 1198,                         /* -no-pie */
